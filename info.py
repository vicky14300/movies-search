...
API_ID = int(environ.get('API_ID','16090180'))
API_HASH = environ.get('API_HASH','e7ad5244bceeb3f8f99a37b6053b5bdc')
BOT_TOKEN = environ.get('BOT_TOKEN','2096081719:AAGQ-Oz7WqP4nbsRJiXkOtUY8iYDHbGFCo8')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1199914276').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001753352348').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://primebot:primebot@cluster0.90gwzxl.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Primebot")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001798243017'))
